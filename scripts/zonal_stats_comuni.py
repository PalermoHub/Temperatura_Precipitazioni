...
(zonal stats: griglia TerraClimate 1950-2025 -> poligoni comuni Sicilia)."""
...
COMUNI_PATH = f"{OUT_DIR}/comuni_sicilia.gpkg"
...
comuni.to_file(f"{OUT_DIR}/comuni_sicilia_clima.gpkg", driver="GPKG")
comuni.drop(columns="geometry").to_csv(f"{OUT_DIR}/comuni_sicilia_clima.csv", index=False)

print(comuni[["comune", "den_prov", "temp_media_c", "precip_media_mm"]].describe())
print(f"Salvato: {OUT_DIR}/comuni_sicilia_clima.gpkg e .csv")
